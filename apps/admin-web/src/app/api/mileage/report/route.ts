...
/**
 * ⚠️ Proxies to `${BACKEND_API_URL}/mileage/report`, a path taken
 ...
 * path or a different response shape than `{ logs: MileageLogEntry[] }`,
    ...
    return NextResponse.json(
      {
        ...
        message:
          err instanceof BackendApiError
            ? err.message
            : "Could not reach /mileage/report — verify this endpoint exists on your backend.",
      },
