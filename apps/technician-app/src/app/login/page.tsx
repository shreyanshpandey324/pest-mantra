      ...
      <div className={`${ui.card} w-full max-w-[420px] overflow-hidden`}>
        ...
        <div className="px-8 pb-8 pt-9">
          <div className="mb-7">
            ...
            <h1 className="mb-1.5 text-[26px]">Technician App</h1>
            <p className="text-sm text-ink-muted">Sign in to view and update your assigned jobs.</p>
          </div>
          ...
          {notAuthorized && (
            ...
            >
              That account doesn&apos;t have access to the technician app. Office staff should use
